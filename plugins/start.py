...
async def start_command(client: Bot, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [[
        InlineKeyboardButton(text="Chat my Owner 🖋️", url=f"https://t.me/video_tante_indonesia/67"),
        InlineKeyboardButton(text="Share Post 👤", url=f"https://t.me/video_tante_indonesia/67")
        ],[
        InlineKeyboardButton(text="➕ Add Me To Your Groups ➕", url=f"https://t.me/tettfileeeshare_bot?startgroup=true")
        ]]
            try:
                await msg.copy(
