...
@Bot.on_message((filters.text|filters.document|filters.video|filters.audio|filters.photo) & filters.chat(CHANNEL_FROM) & filters.incoming & filters.regex(r'https?://[^\s]+'))
